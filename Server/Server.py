...
import csv, threading, time, json, socket
...
class ServerManagementSystem(tk.Tk):
    def __init__(self):
        ...
        # 计算右侧屏幕居中的位置
        x = screen_width - window_width // 2 - (screen_width // 4)
...
class RestaurantManagementSystem(tk.Tk):
    def __init__(self):
        ...
        # 初始化字符并开始显示
        self.characters = ['马瀚鹏', '李韦成', '宋宇阳', '裴科斌']
                ...
                with open('admininfo.csv', 'r') as file:
                    ...
                    for line in lines:
                        ...
                        if username == admin_username and password == admin_password:
                            ...
                            def start_server():
                                # 启动服务器管理窗口
                                self.server_management_system = ServerManagementSystem()
                                self.server_management_system.mainloop()
    ...
    def edit_menu(self):
        ...
        x = (screen_width // 2 - window_width) // 2  # 调整窗口到屏幕左半部分
        y = (screen_height - window_height) // 2
    ...
    def exit_edit(self, current_window):
        current_window.destroy()  # 关闭编辑窗口
